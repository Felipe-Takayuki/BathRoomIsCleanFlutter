                ...
                Center(
                  child: Column(
                    ...
                    // PERGUNTA 1
                     ...
                     // PERGUNTA 3
                           Center(
                        child: CardSurveyWidget(width: mediaquery.width, height: mediaquery.height * 100/100, 
                         ...
                         survey:  Column(
                           children: [
                             Row(
                               children: [
                                const Spacer(),
                                 Column(
                                   children: [
                                     PersonWithNumberWidget(widthImage: mediaquery.width * 6/100, number: "17", fontSize: mediaquery.height * 4/100, padding: EdgeInsets.fromLTRB(mediaquery.width * 2/100, mediaquery.height *4/100, mediaquery.width * 2/100, 0)),
                                     Center(child: Text("Sim", style: GoogleFonts.jetBrainsMono(fontSize: mediaquery.height * 4/100),)),
                                   ],
                                 ),
                                 const Spacer(),
                                  Column(
                                   children: [
                                     PersonWithNumberWidget(widthImage: mediaquery.width * 6/100, number: "5", fontSize: mediaquery.height * 4/100, padding: EdgeInsets.fromLTRB(mediaquery.width * 2/100, mediaquery.height *4/100, mediaquery.width * 2/100, 0)),
                                     Center(child: Text("Não", style: GoogleFonts.jetBrainsMono(fontSize: mediaquery.height * 4/100),)),
                                   ],
                                 ),
                                 const Spacer()
                               ],
                            ...
                            Align(
                              ...
                              child: Padding(
                                      padding: EdgeInsets.only(top: mediaquery.height * 2/100, left: mediaquery.width * 2/100),
                                      child: Text("Alguns relatos:", style: GoogleFonts.jetBrainsMono(color: Colors.white, fontSize: mediaquery.height * 3.5/100),),
                              ),
                            ),
                             Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                                    ...
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: mediaquery.height * 5/100,),
                       ...
                       // PERGUNTA 4
                        ...
                        quest: "4. Como você descreveria a manutenção das torneiras ? Elas costumam funcionar corretamente?",
                         survey:  Column(
                           children: [
                             PersonWithNumberWidget(widthImage: mediaquery.width * 6/100, number: "22", fontSize: mediaquery.height * 4/100, padding: EdgeInsets.fromLTRB(mediaquery.width * 2/100, mediaquery.height *4/100, mediaquery.width * 2/100, 0)),
                            Center(child: Text("Respostas", style: GoogleFonts.jetBrainsMono(fontSize: mediaquery.height * 4/100),)),
                            
                            Align(
                              alignment: Alignment.centerLeft,
                              child: Padding(
                                      padding: EdgeInsets.only(top: mediaquery.height * 2/100, left: mediaquery.width * 2/100),
                                      child: Text("Relatos:", style: GoogleFonts.jetBrainsMono(color: Colors.white, fontSize: mediaquery.height * 3.5/100),),
                              ),
                            ),
                             Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Text('“Conscientização de que o uso do banheiro é para todos e não devemos quebrar o que será usado”', style: GoogleFonts.jetBrainsMono(fontSize: mediaquery.height * 4/100),),
                                          SizedBox(height: mediaquery.height * 5/100,),
                                  
                                          Text('"Talvez se os alunos tivessem acesso facilitado, como por exemplo, os próprio alunos pudessem repor os papéis a manutenção do banheiro poderia melhorar."', style: GoogleFonts.jetBrainsMono(fontSize: mediaquery.height * 4/100),),
                                          SizedBox(height: mediaquery.height * 5/100,),
