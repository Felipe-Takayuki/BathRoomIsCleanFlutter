        ...
        children: [
                ...
                DescWidget(
                    ...
                    desc: Column(
                      ...
                      children: [
                        InkWell(
                            onTap: () =>
                                launchUrlString("https://github.com/Noobolon"),
                            child: Text(
                              "Eduardo Girão",
                        ...
                        InkWell(
                          onTap: () => launchUrlString(
                              "https://github.com/Felipe-Takayuki"),
                          child: Text(
                            "Felipe Takahashi",
                            style: GoogleFonts.jetBrainsMono(
                                fontSize: mediaquery.height * 3 / 100,
                        ...
                        InkWell(
                          onTap: () =>
                              launchUrlString("https://github.com/IsaacZanni"),
                          child: Text(
                            "Isaac Zanni",
                            style: GoogleFonts.jetBrainsMono(
                                fontSize: mediaquery.height * 3 / 100,
          ...
          Padding(
            ...
            child: DescWidget(
              ...
              desc: InkWell(
                onTap: () => launchUrlString(
                    "https://github.com/Felipe-Takayuki/BathRoomIsCleanFlutter/tree/bathroomisclean"),
                child: Text(
                  "código no github",
                  style: GoogleFonts.jetBrainsMono(
                      fontSize: mediaquery.height * 3 / 100,
